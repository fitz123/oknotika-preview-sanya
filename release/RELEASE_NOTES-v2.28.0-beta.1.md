...
Verify `release/SHA256SUMS`, unpack into a new immutable application/marketing release directory and follow `deploy/README_ZHENYA.md`. Content, marketing and application rollback are deliberately separate. Stopping or rolling back the admin application must not move the active public article release.
