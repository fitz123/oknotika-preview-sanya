...
- [x] сохранить существующую taxonomy брендов без перестановки продуктовой логики;
- [x] добавить самостоятельный hero/focus `Schüco — отдельная системная философия фасада`;
- [x] добавить четыре сценария FWS 50, FWS 35 PD, FWS 60 CV и AF UDC 80/80 CV;
- [x] добавить блок интегрированной оболочки: окна, двери, раздвижные элементы, солнцезащита, вентиляция и автоматика только в совместимых конфигурациях;
- [x] добавить блок пути проектирования от фасадной сетки к проверяемому узлу;
- [x] ограничить claim о скрытом дренаже контекстом AWS 75 PD.SI;
- [x] добавить availability/compliance caveat под объект;
- [x] использовать только оригинальную схему и лицензионно безопасные фасадные визуалы; не копировать Schüco logo/photo/render/screenshot/drawing только потому, что они есть на официальном сайте;
- [x] пересказать официальные claims своими словами и записать источник, URL, дату получения, лицензию и поддерживаемый claim каждого опубликованного материала;
- [x] добавить проверку запрещённых обобщений и отсутствующих provenance-записей;
- [x] проверить desktop/mobile page composition и главную карточку алюминия.
